    ...
    def test_client_process_url(self):
        ...
        with mock.patch("builtins.print") as mock_print:
            with mock.patch("threading.current_thread") as mock_current_thread:
                ...
                with mock.patch.object(client, '_read_data') as mock_read_data:
                    mock_read_data.return_value = server_answer
                    ...
                    with mock.patch("socket.socket") as mock_socket_init:
                        ...
                        mock_print.assert_called_once_with(server_answer)
